...
##############older spark creation#############
# sc = SparkContext(appName="KinesisTest")
...
# Define the initial position to start reading the stream
...
#     initialPositionInStream=initialPosition, awsAccessKeyId="AKIAXWAJ4NY3SRVBI7IP",awsSecretKey="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"
